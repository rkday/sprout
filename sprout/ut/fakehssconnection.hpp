...
private:
  long get_json_object(const std::string& path, Json::Value*& object);
  long get_xml_object(const std::string& path, rapidxml::xml_document<>*& root);
  long get_xml_object(const std::string& path, std::string body, rapidxml::xml_document<>*& root);
  long put_for_xml_object(const std::string& path, std::string body, rapidxml::xml_document<>*& root);
